...
# generated by running approximately the following code::
#
...
#
# This was last run on python-2.6.4 with unicodedata_version 5.1.0
...
#
# This table was last regenerated on python-2.6.4 with unicodedata_version 5.1.0
...
def _generate_combining_table():
    ...
    :returns: A list of intervals of :term:`code points` that are combining
        ...
        :term:`codepoint` and the ending code point for the combining characters.
