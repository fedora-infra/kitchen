...
class TestI18N_UTF8(unittest.TestCase, base_classes.UnicodeTestData):
    ...
    def test_easy_gettext_setup(self):
        ...
        tools.eq_(_.im_func.func_name, 'ugettext')
        tools.eq_(N_.im_func.func_name, 'ungettext')
    ...
    def test_easy_gettext_setup_non_unicode(self):
        ...
        tools.eq_(b_.im_func.func_name, 'lgettext')
        tools.eq_(bN_.im_func.func_name, 'lngettext')
